...
class HOWITWORKSIOS(object):
    ...
    def test(self):
        ...
        self.driver.find_element_by_xpath("//UIAApplication[1]/UIAWindow[1]/UIATableView[1]/UIATableCell[13]").click()
        #el = self.driver.find_element_by_xpath("///UIAApplication[1]/UIAWindow[1]/UIATableView[1]/UIATableCell[5]/"
        #                                       "UIAStaticText[1]")
